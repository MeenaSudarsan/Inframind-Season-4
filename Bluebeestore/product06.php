    ...
    <body>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Denim shirt</span>
                    <img class="shop-item-image" src="img\006.jpg">
        ...
        <section class="content-section container">
            ...
            <h2>Description</h2>
            <h3>Dress ID: 006</h3>
            <p>Blue faded denim casual shirt, has a spread collar, long sleeves, button placket, and curved hem </p>
        </section>
        ...
        <section class="content-section container containerforform>"> 
                    ...
                    <?php 
                        ...
                        if(isset($_COOKIE['user'])){
                            ...
                            echo "<input hidden name='dressID' value='006' />";
                        }
                    ?>
...
<section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">DENIM SHIRT</span>
                    <img class="shop-item-image" src="img\similar11.jpg">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                    <span class="shop-item-title">DENIM SHIRT</span>
                    <img class="shop-item-image" src="img\similar12.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₹ 1450.00</span>
                        <button class="btn btn-primary shop-item-button"type="button">VIEW NOW</button>
                    </div>
                    <div>
