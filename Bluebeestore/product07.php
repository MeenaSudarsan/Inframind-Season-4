    ...
    <body>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">White Shirt</span>
                    <img class="shop-item-image" src="img\007.jpg">
        ...
        <section class="content-section container">
            ...
            <h2>Description</h2>
            <h3>Dress ID: 007</h3>
            <p>Trendy Tuxedo Shirt In Slim- Fit Spec Featuring A Cut Away Collar.</p>
        </section>
        ...
        <section class="content-section container containerforform>"> 
                    ...
                    <?php 
                        ...
                        if(isset($_COOKIE['user'])){
                            ...
                            echo "<input hidden name='dressID' value='007' />";
                        }
                    ?>
...
<section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">WHITE SHIRT</span>
                    <img class="shop-item-image" src="img\similar13.jpg">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                    <span class="shop-item-title">WHITE SHIRT</span>
                    <img class="shop-item-image" src="img\similar14.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₹ 1790.00</span>
                        <button class="btn btn-primary shop-item-button"type="button">VIEW NOW</button>
                    </div>
                    <div>
