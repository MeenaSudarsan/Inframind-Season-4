    ...
    <body>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Western Outfit</span>
                    <img class="shop-item-image" src="img\001.jpg">
                    <span class="shop-item-price">₹ 1955.00</span> 
        ...
        <section class="content-section container">
            ...
            <h2>Description</h2>
            <h3>Dress ID: 001</h3>
            <p>Western dress codes are dress codes in Western culture about what clothes are worn for what occasion. Classifications are traditionally divided into formal wear (full dress), semi-formal wear (half dress), and informal wear .  </p>
        </section>
        ...
        <section class="content-section container containerforform>"> 
                    ...
                    <?php 
                        ...
                        if(isset($_COOKIE['user'])){
                            ...
                            echo "<input hidden name='dressID' value='001' />";
                        }
                    ?>
...
<section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    ...
                    <img class="shop-item-image" src="img\similar01.jpg">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                    <span class="shop-item-title">CLASSIC WESTERN</span>
                    <img class="shop-item-image" src="img\similar02.jpg">
                    <div class="shop-item-details">
