    ...
    <body>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Blue Jean</span>
                    <img class="shop-item-image" src="img\005.jpg">
                    <span class="shop-item-price">₹ 1200.00</span> 
        ...
        <section class="content-section container">
            ...
            <h2>Description</h2>
            <h3>Dress ID: 005</h3>
            <p>Blue coloured wash 5-pocket mid-rise jeans, clean look with no fade, has a button and zip closure, waistband with belt loops </p>
        </section>
        ...
        <section class="content-section container containerforform>"> 
                    ...
                    <?php 
                        ...
                        if(isset($_COOKIE['user'])){
                            ...
                            echo "<input hidden name='dressID' value='005' />";
                        }
                    ?>
...
<section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">BLUE JEANS</span>
                    <img class="shop-item-image" src="img\similar09.jpg">
                    <div class="shop-item-details">
                ...
                <div class="shop-item">
                    <span class="shop-item-title">BLUE JEANS</span>
                    <img class="shop-item-image" src="img\similar10.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₹ 1250.00</span>
                        <button class="btn btn-primary shop-item-button"type="button">VIEW NOW</button>
                    </div>
                    <div>
