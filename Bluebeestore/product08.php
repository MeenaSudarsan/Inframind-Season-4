    ...
    <body>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Pair Of Jeans</span>
                    <img class="shop-item-image" src="img\008.jpg">
                    <span class="shop-item-price">₹ 1799.00</span> 
        ...
        <section class="content-section container">
            ...
            <h2>Description</h2>
            <h3>Dress ID: 008</h3>
            <p> Blue Light wash 5-pocket two toned mid-rise jeans, low distress, light fade, has a button and zip closure, and waistband with belt loops  </p>
        </section>
        ...
        <section class="content-section container containerforform>"> 
                    ...
                    <?php 
                        ...
                        if(isset($_COOKIE['user'])){
                            ...
                            echo "<input hidden name='dressID' value='008' />";
                        }
                    ?>
...
<section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">PAIR OF JEANS</span>
                    <img class="shop-item-image" src="img\similar15.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₹ 1599.00</span>
                ...
                <div class="shop-item">
                    <span class="shop-item-title">PAIR OF JEANS</span>
                    <img class="shop-item-image" src="img\similar16.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₹ 1579.00</span>
                        <button class="btn btn-primary shop-item-button"type="button">VIEW NOW</button>
                    </div>
                    <div>
