    ...
    <body>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Modern Outfit</span>
                    <img class="shop-item-image" src="img\004.jpg">
        ...
        <section class="content-section container">
            ...
            <h2>Description</h2>
            <h3>Dress ID: 004</h3>
            <p>Modern dress is a term used in theatre and film to refer to productions of plays from the past in which the setting is updated to the present day (or at least to a more recent time period), but the text is left relatively unchanged </p>
        </section>
        ...
        <section class="content-section container containerforform>"> 
                    ...
                    <?php 
                        ...
                        if(isset($_COOKIE['user'])){
                            ...
                            echo "<input hidden name='dressID' value='004' />";
                        }
                    ?>
...
<section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">MODERN OUTFIT</span>
                    <img class="shop-item-image" src="img\similar07.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">₹ 1350.00</span>
                ...
                <div class="shop-item">
                    <span class="shop-item-title">CLASSIC WESTERN</span>
                    <img class="shop-item-image" src="img\similar08.jpg">
                    <div class="shop-item-details">
